...
def is_trusted_domain(url: str) -> bool:
    """
    Return True when the URL belongs to one of the explicitly
    trusted registered domains.
    """
...
def calculate_final_risk(
    ...
    if (
        ...
        # Hostname receives higher weight because hostname
        # structure is particularly useful for phishing detection.
    ...
    if threat_intel_status == "success":
        ...
        # It does not dominate local ML/rule detection.
        ...
        # Graceful degradation when VirusTotal
        # is unavailable.
    ...
    # Brand impersonation + authentication
    if (
        brand_impersonation
        and suspicious_auth_path
    ):
    ...
    # =====================================================
    # HOSTNAME MODEL SAFETY FLOOR
    # =====================================================

    if hostname_probability is not None:

        if hostname_probability >= 0.90:
        ...
        elif hostname_probability >= 0.80:
